...
import com.goheung.app.databinding.ItemChatRoomDmBinding
import com.goheung.app.databinding.ItemChatRoomGroupBinding
...
class ChatListAdapter(
    ...
    class GroupViewHolder(
        ...
        private fun formatParticipants(participants: List<com.goheung.app.data.model.User>): String {
            return when {
